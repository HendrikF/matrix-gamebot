...
Bot.prototype._onInvitation = function(event) {
    ...
    this.bridge.getIntent().createRoom({
        ...
        // TODO explain syntax, who is which symbol, etc.
        self.bridge.getIntent().sendText(room_id,
            "Hey,\nwelcome to a new exciting tic-tac-toe match between " + users.join(", ") + ".");
    });
}
